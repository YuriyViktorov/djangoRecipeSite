...
def index(request):
    ...
    count = Recipe.objects.filter(is_visible=True).count()
    if count == 0:
        return render(request, "recipeSiteapp/index.html")
    if count == 1:
        recipes = [Recipe.objects.all()[0]]
        return render(request, "recipeSiteapp/index.html", {'recipes': recipes})
...
def user(request):
    ...
    return render(request, 'recipeSiteapp/user.html', context)
...
def cooker(request):
    ...
    return render(request, "recipeSiteapp/cooker.html", {'recipes': recipes})
...
def recipe_add(request):
    ...
    if request.method == 'POST':
        ...
        is_completed = False
        form = RecipeForm()
    return render(request, 'recipeSiteapp/recipe_add.html',
...
def recipe_edit(request, recipe_id):
    ...
    if request.method == 'POST':
        ...
        if recipe:
            ...
            form = RecipeForm()
    return render(request, 'recipeSiteapp/recipe_edit.html',
                  {'form': form,
...
def recipe_detail(request, recipe_id):
    ...
    return render(request, 'recipeSiteapp/recipe_detail.html', context)
